...
class _DashboardScreenState extends State<DashboardScreen> {
      ...
      reader.onLoadEnd.listen((e) {
        if (reader.result != null) {
          try {
            ...
            filesize="${file.size}";
            filetype="${file.type}";
            _finalcustomerimageBytes="<Buffer ${_customerimageBytes!.take(20).map((b) => b.toRadixString(16).padLeft(2, '0')).join(' ')} ... ${_customerimageBytes!.length} more bytes>" as Uint8List;
            print("Buffer: <Buffer ${_customerimageBytes!.take(20).map((b) => b.toRadixString(16).padLeft(2, '0')).join(' ')} ... ${_customerimageBytes!.length} more bytes>");
  ...
  final SalarystatusController salarystatusController=Get.find<SalarystatusController>();
              ...
              SizedBox(
                  ...
                  child: getAdminallOrdersController.getallorderdata.isEmpty?
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                          ...
                          crossAxisCount: 4),
                      itemCount: getAdminallOrdersController.getallorderdata.length,
                      itemBuilder: (BuildContext context,int index){
                        var data=getAdminallOrdersController.getallorderdata[index];
                        return Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: InkWell(
                            onTap: (){
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Padding(
                                                          ...
                                                          child: InkWell(
                                                            onTap: (){
                                                              showloadingdialog(context);
                                                              salarystatusController.SalarystatusAPI(context, data['id']??"", "COMPLETED");
                                                              getallSalaryController.GetAllSalaryApi(context);
                                                              Get.back();
                                                            },
                                                            child: Container(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    Icon(Icons.check,color: Colors.green.shade800,size: 20,),
                                                                    Padding(
                                                                      padding: const EdgeInsets.only(left:8.0),
                                                                      child: Text("COMPLETED", style: commonstyleweb(color: Colors.green.shade800,weight: FontWeight.w600)),
                                                                    ),
                                                                  ],
                                                                ),
                                                              ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          onTap: (){
                                                            showloadingdialog(context);
                                                            salarystatusController.SalarystatusAPI(context, data['id']??"", "CANCELLED");
                                                            getallSalaryController.GetAllSalaryApi(context);
                                                            Get.back();
                                                          },
                                                          child: Container(
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                crossAxisAlignment: CrossAxisAlignment.center,
                                                                children: [
                                                                  Icon(Icons.close,color: Colors.red.shade800,size: 20,),
                                                                  Padding(
                                                                    padding: const EdgeInsets.only(left:8.0),
                                                                    child: Text("CANCEL", style: commonstyleweb(color: Colors.red.shade800,weight: FontWeight.w600)),
                                                                  ),
                                                                ],
                                                              ),
                                                            ),
                                                    ...
                                                    SizedBox(
                                                        width: displaywidth(context) * 0.20,
                                                        child: Center(child: Text("${data['isCompleted']}",style: commonstyle(weight: FontWeight.w600,size: 15,color:data['isCompleted']=="COMPLETED"?Colors.green:Colors.orange ),)))
                                              ],
                                            ),
                                          ),
                                        ),
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("View Delivery Payment Details",style: commonstyleweb(color: Colors.black),),
                    )
                  ],
                ),
              ),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Text("Delivery Partner Mobile Number : ",style: commonstyle(weight: FontWeight.w700,color: Colors.black,size: 15),),
                                          Text("+918767876787",style: commonstyle(color: Colors.black,size: 15),)
                                        ],
                                      ),
                                    ),
                                  ],
                              ...
                              Padding(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text("Delivery Partner Address : ",style: commonstyle(weight: FontWeight.w700,color: Colors.black,size: 15),),
                                      Text("14, Old GST Rd, Varadharaja Nagar, Chengalpattu, Tamil Nadu 603001, India",style: commonstyle(color: Colors.black,size: 15),)
                                    ],
                                  ),
                                ),
                              ),
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("Payment Details",style: commonstyle(size: 18,weight: FontWeight.w700,color: Color_Constant.primarycolr),),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Container(
                              ...
                              child: Column(
                                children: [
                                  InkWell(
                                    onTap:(){
                                      setState(() {
                                        Map<String,dynamic> data=getOrderHistoryController.getorderdata[index];
                                ...
                                children: [
                                  InkWell(
                                    onTap:(){
                                      setState(() {
                                        print(Viewsubscriptiondata);
                                        data=getSubscriptionHistoryController.getsubscriptiondata[index];
                                        Get.to(ViewsubscriptionScreen(data: data,));
                                      });
                                    },
                                    child: Container(
                                      width: double.infinity,
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: ()async{
                            if(usernamecontroller.text.isEmpty||useremailcontroller.text.isEmpty||usernumbercontroller.text.isEmpty||userpasswordcontroller.text.isEmpty||useraddresscontroller.text.isEmpty||SelectedHubtoUsers.toString().isEmpty){
                              ...
                              showloadingdialog(context);
                                addUsersController.AddUserAPI(context, useremailcontroller.text, userpasswordcontroller.text, usernamecontroller.text, usernumbercontroller.text, useraddresscontroller.text, _customerimageBytes.toString(),usercitycontroller.text,userstatecontroller.text,userpincodecontroller.text,selectedhubid??0);
                                await searchUsersController.SearchUserAPI(context,"","");
                              Get.back();
                            }
                          },
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Center(
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text("Hub UserId",style: commonstyleweb(color: Colors.black,weight: FontWeight.w600),),
                              ),
                            ),
                          ),
                          SizedBox(
                              ...
                              child: Column(
                                children: [
                                  InkWell(
                                    onTap:(){
                                      setState(() {
                                        Get.to(ViewhubScreen(id:data['id'],hubname:data['username']??"",));
                                      });
                                    },
                                    child: Container(
                                      width: double.infinity,
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                              ...
                                              child:  Center(
                                                child: Padding(
                                                  padding: EdgeInsets.all(8.0),
                                                  child: Text("${data['hubAutoID']}", style: commonstyleweb(color: Colors.black)),
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                ...
                                                child:  Center(
                                                  child: Padding(
                                                    padding: EdgeInsets.all(8.0),
                                                    child: Text("${data['userAutoID']}", style: commonstyleweb(color: Colors.black)),
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                color:activecontainer==1?Colors.white:Colors.transparent,
                            ...
                            child: Padding(
                              ...
                              child: Padding(
                                ...
                                child: Text("Active Customers",style: commonstyle(color: activecontainer==1?Colors.black:Colors.white,size: 15,weight: FontWeight.w500),),
                              ),
                            ),
                          ),
                        ),
                        InkWell(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                color:activecontainer==2?Colors.white:Colors.transparent,
                                borderRadius: BorderRadius.circular(30.0)
                            ),
                            child: Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Padding(
                                padding: const EdgeInsets.symmetric(horizontal: 25.0),
                                child: Text("In Active Customers",style: commonstyle(color: activecontainer==2?Colors.black:Colors.white,size: 15,weight: FontWeight.w500),),
                              ),
                            ),
                          ),
                        ),
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Center(
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text("Address",style: commonstyleweb(color: Colors.black,weight: FontWeight.w600),),
                              ),
                            ),
                          ),
                          // SizedBox(
                    ...
                    child: FutureBuilder(
                      ...
                      builder: (BuildContext context, AsyncSnapshot<List<dynamic>> snapshot) {
                        ...
                        return RefreshIndicator(
                          ...
                          child: Obx(
                                ()=> ListView.builder(
                              itemCount: activecontainer == 1?searchuserdata.where((user)=>user['isSubscriptionValid']==true).length:searchuserdata.where((user)=>user['isSubscriptionValid']==false).length,
                              itemBuilder: (BuildContext context, int index) {
                                var truedata=searchuserdata.where((user)=>user['isSubscriptionValid']==true).toList();
                                var falsedata=searchuserdata.where((user)=>user['isSubscriptionValid']==false).toList();
                                var data = activecontainer == 1?truedata[index]:falsedata[index];
                                return Padding(
                                  padding: const EdgeInsets.symmetric(vertical: 8.0),
                                  child: Column(
                                    children: [
