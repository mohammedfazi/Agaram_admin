...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  List<String> paymentlist=['COMPLETED','PENDING','INPROGRESS'];
...
//change password controller
  ...
  List<XFile?> files = [null, null, null, null]; // List to store images
  List<String?> base64Strings = [null, null, null, null]; // List for base64 strings
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: ()async{
                          ...
                          addProductController.AddProductAPI(context, productnamecontroller.text, productdescriptioncontroller.text,
                              productpricecontroller.text, productqtycontroller.text, SelectedSubscriptionStatus.toString(),
                              "");
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: ()async{
                          if(usernamecontroller.text.isEmpty||useremailcontroller.text.isEmpty||usernumbercontroller.text.isEmpty||userpasswordcontroller.text.isEmpty||useraddresscontroller.text.isEmpty){
                            ...
                            showloadingdialog(context);
                            addUsersController.AddUserAPI(context, useremailcontroller.text, userpasswordcontroller.text, usernamecontroller.text, usernumbercontroller.text, useraddresscontroller.text, _customerimageBytes.toString());
                                              ...
                                              child: Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      IconButton(onPressed: (){}, icon: const Icon(CupertinoIcons.pen,color: Colors.grey,size: 20,)),
                                                      IconButton(onPressed: (){
                                                        DeleteHub(data['id']??1);
                                                      }, icon: const Icon(CupertinoIcons.delete,color: Colors.grey,size: 20,))
                                                    ],
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    width: double.infinity,
                    child: Obx(
                        ()=> getalldeliveryController.getalldeliverytdata.isEmpty?
                            const Center(
                              child: CupertinoActivityIndicator(),
                            )
                            :ListView.builder(
                          itemCount: getalldeliveryController.getalldeliverytdata.length,
                          itemBuilder: (BuildContext context,int index){
                            var data=getalldeliveryController.getalldeliverytdata[index];
                            return Padding(
                              padding: const EdgeInsets.symmetric(vertical: 8.0),
                                              ...
                                              child: Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      IconButton(onPressed: (){
                                                        Map<String,dynamic> data=getalldeliveryController.getalldeliverytdata[index];
